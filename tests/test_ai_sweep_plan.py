...
from field_analysis.ai_sweep.sweep_plan import SweepPlanConfig, build_sweep_plan, plan_to_dataframe
...
def test_ai_sweep_plan_does_not_import_streamlit() -> None:
    import field_analysis.ai_sweep.sweep_plan as sweep_plan
