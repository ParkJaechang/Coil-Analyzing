...
from field_analysis.ai_sweep.manifest_io import manifest_rows_to_dataframe
from field_analysis.ai_sweep.schema import SweepSegmentManifestRow
from field_analysis.ai_sweep.segment_parser import split_long_measurement_by_manifest
...
def test_ai_sweep_segment_parser_does_not_import_streamlit_or_production_modeling() -> None:
    import field_analysis.ai_sweep.segment_parser as segment_parser
