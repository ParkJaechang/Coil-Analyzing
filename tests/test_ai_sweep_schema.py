...
def test_ai_sweep_package_does_not_import_streamlit() -> None:
    import field_analysis.ai_sweep as ai_sweep
    import field_analysis.ai_sweep.manifest_io as manifest_io
    import field_analysis.ai_sweep.schema as schema
