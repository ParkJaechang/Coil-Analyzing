...
def _render_support_reference_provenance_panel(
    ...
    with raw_right:
        ...
        st.write(f"- mapping mode: `{_format_optional_text(_support_provenance_value(compensation, command_profile, 'support_reference_timebase_mapping_mode'))}`")
        st.write(f"- anchor mode: `{_format_optional_text(_support_provenance_value(compensation, command_profile, 'support_reference_anchor_mode'))}`")
        st.write(f"- source window start: `{_format_optional_metric(_support_provenance_value(compensation, command_profile, 'support_reference_source_window_start_s'), 's')}`")
        st.write(f"- source window end: `{_format_optional_metric(_support_provenance_value(compensation, command_profile, 'support_reference_source_window_end_s'), 's')}`")
        st.write(f"- source window duration: `{_format_optional_metric(_support_provenance_value(compensation, command_profile, 'support_reference_source_window_duration_s'), 's')}`")
        st.write(f"- expected duration: `{_format_optional_metric(_support_provenance_value(compensation, command_profile, 'support_reference_expected_duration_s'), 's')}`")
        st.write(f"- source window reason: `{_format_optional_text(_support_provenance_value(compensation, command_profile, 'support_reference_source_window_reason'))}`")
        st.write(f"- pre-baseline excluded: `{_format_optional_bool(_support_provenance_value(compensation, command_profile, 'source_pre_baseline_excluded_from_reference'))}`")
        st.write(f"- tail excluded: `{_format_optional_bool(_support_provenance_value(compensation, command_profile, 'source_tail_excluded_from_reference'))}`")
